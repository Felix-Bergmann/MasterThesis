...
public class IS_in_simple_symmFHG_pers_Utility {
            ...
            for (int i = 0; i < n; i++) {
                for (int c = 0; c < m; c++) {
                    ...
                    if(allow_deviation(i,c)){
                        ...
                        double u = compute_utility(i,c);
                        if(u - curr_utility[i] > util_increase){
                            deviating_agent = i;
                            dest_coalition = c;
                            util_increase = u - curr_utility[i];
                        }
                    }
                }
            }
