...
public class Test_CS_all_coalitions_and_utilities {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println((end_t - start_t)+" ms");
    }    
    ...
    public static void blocking_Coalition_exists(int[][] utilities, ArrayList<Integer>[] coalitions){
        ...
        ArrayList<Integer> blocking_coal0 = heuristic0_ISdeviation.find_BlockCoal(coalitions, utilities, notEliminated, curr_utility, simple);
        ArrayList<Integer> blocking_coal1 = heuristic1_Coalitions.find_BlockCoal(coalitions, utilities, notEliminated, curr_utility, simple);
        ...
        ArrayList<Integer> blocking_coal4 = heuristic_Size4.find_BlockCoal(coalitions, utilities, notEliminated, curr_utility, simple);
        ArrayList<Integer> blocking_coal5 = heuristic_Size5.find_BlockCoal(coalitions, utilities, notEliminated, curr_utility, simple);
        ArrayList<Integer> blocking_coal6 = heuristic_Size6.find_BlockCoal(coalitions, utilities, notEliminated, curr_utility, simple);
